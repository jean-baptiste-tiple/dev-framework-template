...
1. Lire [`.tiple/conventions/_index.md`](../../../.tiple/conventions/_index.md).
...
- Il n'écrit **jamais** dans `.tiple/conventions/` — c'est le rôle de `tm-wrap-up`, sur accord explicite.
